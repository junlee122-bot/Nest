...
- **⚡ 에어컨 전기요금 계산 (`/utility` 기본 탭)**: 종류·냉방 평수·사용시간만으로 한 달 예상 추가요금을 즉시 계산. 한전 누진제(하계/기타·저압/고압·슈퍼유저) 전후 차이 기반의 **결정론적 순수 함수 엔진**(AI 미사용, 네트워크 0회), 낮음·중앙·높음 범위 표시. 상세: `docs/AIRCON_CALCULATOR.md`
